...
data_tr = pd.read_csv('./luad_train.csv', header=None).iloc[:,1:]
...
data_te = pd.read_csv('./luad_test.csv', header=None).iloc[:,1:]
...
exp_adj1 = torch.tensor(pd.read_csv('./adj1.csv', header=None).values, dtype=torch.long)
exp_adj2 = torch.tensor(pd.read_csv('./adj2.csv', header=None).values, dtype=torch.long)
exp_adj3 = torch.tensor(pd.read_csv('./adj3.csv', header=None).values, dtype=torch.long)
