...
#
data_tr = loaded_data[f"data_{tr_label}"]
tr_omic = loaded_data[f"{tr_label}_omic"]
tr_labels = loaded_data[f"{tr_label}_labels"]
data_te = loaded_data[f"data_{te_label}"]
te_omic = loaded_data[f"{te_label}_omic"]
te_labels = loaded_data[f"{te_label}_labels"]
